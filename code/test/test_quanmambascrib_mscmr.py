...
parser.add_argument("--model_path", type=str, default="../../checkpoints/MSCMR_QuanMambaScrib/quanmambascrib_best_model.pth")
...
def test_single_volume(case, net, cfg):
    h5f = h5py.File(os.path.join(cfg.root_path, "MSCMR_testing_volumes", "{}.h5".format(case)), "r")
    image = h5f["image"][:]
    label = h5f["label"][:]
