...
def log_dense_debug(writer, pseudo_info, sampled_batch, iter_num, dense_label_key):
    ...
    for _ in iterator:
        for sampled_batch in trainloader:
            ...
            if iter_num % train_args.pseudo_metric_interval == 0:
                log_dense_debug(writer, pseudo_info, sampled_batch, iter_num, train_args.dense_label_key)
