...
parser.add_argument('--exp', type=str, default='RPG_MT_CONF', help='experiment name')
...
parser.add_argument('--pseudo_margin_thresh', type=float, default=0.1,
                    help='fixed minimum confidence margin in disagreement pixels')
        ...
        for sampled_batch in trainloader:
            ...
            if iter_num % 200 == 0:
                logging.info(
                    ...
                    'lambda_p %.4f | lambda_proto %.4f | agree_th %.4f | disagree_th %.4f | margin_th %.4f | '
                    'rel %.4f | agree %.4f | disagree %.4f | graph_w %.4f',
                    iter_num,
                    loss.item(),
                    loss_pce.item(),
                    loss_ghrd.item(),
